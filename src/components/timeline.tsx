...
const Timeline = (props: Props) => {
  ...
  useEffect(() => {
    ...
    const textElements = document.querySelectorAll('.stagger p, .stagger h3')
    ...
    <ComponentWrapper>
      ...
      <div ref={ref} className={`${inView ? 'opacity-100' : 'opacity-0'}`}>
        <ul className="grid grid-cols-12">
          <li className="stagger col-start-1 col-span-3">
            <div>
          ...
          <li className="stagger col-start-4 col-span-3">
          ...
          <li className="stagger col-start-7 col-span-3">
          ...
          <li className="stagger col-start-10 col-span-3">
